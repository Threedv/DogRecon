...
parser.add_argument('--initial_weight', type=float, default=0.9, help='Initial weight for the mask blending')
...
def predict(device_idx: int =_GPU_INDEX,
    ...
    for i in range(0, 356, 5):
        ...
        #output_image_path = f'/home/user/gs/huggstudy/GART/data/dog_data_official/{image_name}/dh_images/{n:04d}.png'
