...
class DDIMSampler(object):
    ...
    def sample(self,
               ...
               dynamic_threshold=None, mask_36=None,white_mask=None,lv2_mask=None, lv3_mask=None,
               **kwargs
               ):
        ...
        samples, intermediates = self.ddim_sampling(conditioning, size,
                                                    ...
                                                    dynamic_threshold=dynamic_threshold,mask_36=mask_36, white_mask=white_mask, lv2_mask=lv2_mask, lv3_mask=lv3_mask,
                                                    )
    ...
    def ddim_sampling(self, cond, shape,
                      ...
                      t_start=-1, mask_36=None, white_mask=None, lv2_mask=None, lv3_mask=None):
        ...
        resize_torch = torch.from_numpy(resize_np).to(device=device, dtype=img.dtype)
        ...
        for i, step in enumerate(iterator):
            ...
            if i == 27:
                ...
                L1_mask = img * l1_mask 
                L2_mask = ((l2_weight) * (img * l2_mask)) + ((1 - l2_weight) * (white_img * l2_mask))
                L3_mask = ((l3_weight) * (img * l3_mask)) + ((1 - l3_weight) * (white_img * l3_mask))
                Background = white_img * back_mask
                
                Composed_img = L1_mask + L2_mask + L3_mask + Background
            ...
            outs = self.p_sample_ddim(img, cond, ts, index=index, use_original_steps=ddim_use_original_steps,
                                      ...
                                      unconditional_guidance_scale=unconditional_guidance_scale,
                                      unconditional_conditioning=unconditional_conditioning,
                                      dynamic_threshold=dynamic_threshold,mask_36=mask_36)
            img, pred_x0 = outs
    ...
    def p_sample_ddim(self, x, c, t, index, repeat_noise=False, use_original_steps=False, quantize_denoised=False,
                      ...
                      dynamic_threshold=None, mask_36=None):
