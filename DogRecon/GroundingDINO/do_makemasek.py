...
#python do_makemasek.py --image_path /home/user/gs/huggstudy/GART/data/dog_data_official/oneshot_french --folder_int 0
...
if __name__ == "__main__":
   ...
   #parser.add_argument("--keypoints_path", type=str, default=None)
    ...
    grounding_dino_model = Model("groundingdino/config/GroundingDINO_SwinT_OGC.py", "weights/groundingdino_swint_ogc.pth") 

    save_path = image_path+folder_list[folder_int]
    print(save_path)
