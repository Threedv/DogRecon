...
class BITEInferenceModel():        #(nn.Module):
    def __init__(self, cfg, path_model_file_complete, norm_dict, device='cuda'):
        ...
        # path_model_file_complete 이거 들어간다. 그렇기 때문에 뭔가 다르지 않을까?
        ...
        self.complete_model.load_state_dict(state_dict_complete)    # , strict=False)     #여기서 state dict를 부르네..    
