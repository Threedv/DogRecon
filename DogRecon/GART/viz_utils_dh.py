...
def viz_dog_all(solver, data_provider, model=None, ckpt_dir=None, viz_name=""):
    ...
    aroot = osp.join(osp.dirname(__file__), "novel_poses/ijcv_dog_motion/pred")
    ...
    file = f"{aroot}/doggieMN5_runforwardRM_interpolated_pose.npy"
    filename = osp.splitext(osp.basename(file))[0]
  ...
  -0.0000000,  0.0000000, -1.0000000 ]])
    ...
    new_viz_dir = "/home/user/gs/huggstudy/GART/ijcv_motion_interpolation_result/oneshot_shiba2_zero"
    ...
    viz_dog_animation(
        ...
        data_provider.W,
        data_provider.K_list[0],
        save_path=osp.join(new_viz_dir, f"{filename}_animation.gif"),
        fps=60,
    )
    return
